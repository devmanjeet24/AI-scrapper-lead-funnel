...
export function ScrapeJobsTableSkeleton() {
  return (
    <div
      className={cn(
      ...
      aria-busy="true"
      aria-label="Loading scrape jobs"
    >
      ...
      <div className="divide-y divide-border/50">
        {Array.from({ length: SKELETON_ROWS }, (_, index) => (
          <div key={index} className="flex items-center gap-4 px-5 py-4">
            ...
            <div className="hidden h-6 w-20 animate-pulse rounded-full bg-foreground/5 sm:block" />
            <div className="hidden h-6 w-20 animate-pulse rounded-full bg-foreground/5 md:block" />
            <div className="hidden h-4 w-48 animate-pulse rounded bg-foreground/5 lg:block" />
