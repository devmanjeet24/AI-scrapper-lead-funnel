...
interface ScrapeJobsErrorStateProps {
  message: string
  onRetry: () => void
}

export function ScrapeJobsErrorState({ message, onRetry }: ScrapeJobsErrorStateProps) {
  return (
    <div
      className={cn(
    ...
    >
      ...
      <h3 className="text-lg font-semibold text-foreground">Failed to load scrape jobs</h3>
